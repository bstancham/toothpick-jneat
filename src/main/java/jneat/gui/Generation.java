...
public class Generation extends JPanel implements ActionListener, ItemListener {
    ...
    JRadioButton ck1;
    JRadioButton ck2; // graph champion
    JRadioButton ck3;
    ...
    public Generation(JFrame _f) {
        ...
        paneScroll2.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(2, 2, 2, 2),
    ...
    public void buildConstraints(GridBagConstraints gbc, int gx, int gy, int gw, int gh, int wx, int wy) {
        msg("Generation.buildConstraints() --- START");
        gbc.gridx = gx;
        gbc.gridy = gy;
        gbc.gridwidth = gw;
        gbc.gridheight = gh;
        gbc.weightx = wx;
        gbc.weighty = wy;
        msg("Generation.buildConstraints() --- END");
    }
    ...
    public void startProcessAsync() {
        msg("Generation.startProcessAsync() --- START");
        Runnable lookupRun =
            new Runnable() {
                public void run() {
        ...
        lookupThread.start();
        msg("Generation.startProcessAsync() --- END");
    }
    ...
    /**
     * Instantiates methods and classes required (input/target/fitness).
     *
     * Sets up a bunch of other variables.
     *
    ...
    public EpochParams startNeat_START() {
        ...
        try {
            ...
            if (EnvConstant.TYPE_OF_SIMULATION == EnvConstant.SIMULATION_FROM_TOOTHPICK) {
                ...
                Method_fit = Class_fit.getMethod("getMaxFitness");
                // ObjRet_fit = Method_fit.invoke(ObjClass_fit, null);
                ObjRet_fit = Method_fit.invoke(ObjClass_fit);
                ...
                if (EnvConstant.TYPE_OF_SIMULATION == EnvConstant.SIMULATION_FROM_CLASS) {
                    ...
                    Method_inp = Class_inp.getMethod("getNumUnit");
                    ...
                    // ObjRet_inp = Method_inp.invoke(ObjClass_inp, null);
                    Method_inp = Class_inp.getMethod("getNumSamples");
                    ObjRet_inp = Method_inp.invoke(ObjClass_inp);
                    ...
                    Method_tgt = Class_tgt.getMethod("getNumUnit");
            ...
            logger.sendToLog(" generation: error in startNeat(), setting up fitness class: " + ed);
            ed.printStackTrace();
        }
    ...
    public boolean evaluate(Organism organism) {
        msg("Generation.evaluate() --- START");
        double fit_dyn = 0.0;
        double err_dyn = 0.0;
        double win_dyn = 0.0;

        // to avoid errors the number of inputs and outputs is calculated based on
        // to the data;
        // for unit inputs a unit bias is added to that number
        // of type neuron
        // the input and output copdification classes will therefore have to provide two
        ...
        if (success) {
            try {
                if (EnvConstant.TYPE_OF_SIMULATION == EnvConstant.SIMULATION_FROM_CLASS) {
                    ...
                    // before going on to calculate the fitness read the tgt to review
                    // to the caller
    ...
    public boolean afterEpochForToothpick(EpochParams ep, Organism generationFirstWinner) {
        ...
        try {
            ...
            if (firstWinner != null) {
                ...
                // 01.06.2002 : store only first organism
                if (EnvConstant.FIRST_ORGANISM_WINNER == null) {
                    EnvConstant.FIRST_ORGANISM_WINNER = firstWinner;
                    // System.out.print("\n okay flagged first *****");
                }
            }
            ...
            msg("Generation.epochForToothpick() --- END");
    ...
    public void setStyleNew(JTextPane textPane1) {
        msg("Generation.setStyleNew() --- START");
        ...
        msg("Generation.setStyleNew() --- END");
    }
    ...
    public void drawCurve(String _riga, double _fitness,int _generation,int _nrspecies,int _popsize) {
        msg("Generation.drawCurve() --- START");
        ...
        msg("Generation.drawCurve() --- END");
    }

    public void setGraphView() {
        msg("Generation.setGraphView() --- START");
    ...
    public void drawGraph(Organism  _o1,String _riga,chartXY _mappa) {
        ...
        msg("Generation.drawGraph() --- END");
    }

    public void initAllMap() {
        msg("Generation.initAllMap() --- START");
        textPane2.setText("");
        p3_text.repaint();
        ...
        msg("Generation.initAllMap() --- END");
    }

    public void ViewGeneric() {
        msg("Generation.ViewGeneric() --- START");
        String ckx = ck_group.getSelection().getActionCommand();
        ...
        msg("Generation.ViewGeneric() --- END");
    }
