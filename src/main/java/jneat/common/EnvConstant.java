...
public class EnvConstant {
    ...
    public static String NAME_PARAMETER = "neat-params";

    // current file name for parameter single without dir o other)
    public static String NAME_SESSION = "session-params";
    ...
    // setting number of inputs/outputs for neural networks in organisms?
    public static int NR_UNIT_INPUT = 2;
    public static int NR_UNIT_OUTPUT = 1;
    // num units for hidden layers? (check this)
