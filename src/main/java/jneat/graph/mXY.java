...
public class mXY {
    ...
    public void computeMacro(Vector vEdge) 
    {
        ...
        //
        // alloca la matrice che conterra i nodi e marca i punti
        ...
        */
        ...
        // per fare cio legge la riga e ogni volta che trova un nodo
        // 
        ...
        for (iA = 0; iA < dim_x; iA++) 
            {
                ...
                if (_o != null) {
                    ...
                    // se non lo trova non fa nulla e passa al nodo successivo
                    // 
                    ...
                    //
                    // questo e il caso in cui il nodo di output non ha connessioni
                    // verso alcuno per cui lo lascia stare come e!
                    //
                    else 
                        {
        ...
        for (int layer = 0; layer < (dim_y-1) ; layer++) 
            {
                ...
                //    se si :
                //       verifica i figli e al primo figlio , cioe nodo nel layer
                ...
                //       nodi ;
                // Il motivo per cui non piazza subito tutti i nodi e che se si agisse in tale senso
                        ...
                        for (iA = 0; iA < dim_x; iA++) 
                            {
                                ...
                                // quindi  la prima cosa da fare e :
                                                        ...
                                                        if (_py != null) 
                                                            {
                                                                ...
                                                                /*						else if (!(_o.has_child(_py)))
                                                                                                                System.out.print("\n    -> scarto " + _py.name + " perche non e figlio di " + _o.name); 
                                                                                                                else if (_py.is_traversed)
                                                                                                                System.out.print("\n    -> scarto " + _py.name + " perche gia fatto");
                                                                */
                                                            }
						...
						if (done) 
                                                    {
                                                        ...
                                                        // deve essere trovato;
                                                        // se cosi non e allora esiste un errore nel calcolo o del baricentro o dell'assegnazione dei
                                                        // nodi
                                                        //
                                                        ...
                                                        for (int k = 0; k < max_range ; k++) 
                                                            {
                                                                ...
                                                                //						System.out.print("\n vedo se su matrix["+Lb+"]["+raggio + "] c'e posto!");
                                                                ...
                                                                if ((raggio >= 0) && (raggio < dim_x)) 
                                                                    {
                                                                        ...
                                                                        // se raggio e nei limiti allora verifico se il posto e disponibile
                                                                        //
                                                                        //						   System.out.print("\n    okay indice " + raggio+" corretto : verifico se matrix["+raggio+"] e libero!");
                ...
                // In pratica cerca i nodi virtuali su Lb e se il nodo e una estensione di un link
                        ...
                        if (_o != null) 
                            {
                                ...
                                if (_o.is_virtual()) 
                                    //			if (_o.type == 4) 
                                    {
                                        // okay nodo virtuale , vedo se fa parte un gruppo di nodi virtuali
						...
						for (i = 0; i < l.size(); i++) 
                                                    {
                                                        ...
                                                        //					 System.out.print("\n leggo elem(" + i + ") = " + e.name);
                                                        // se il nodo non e stato marcato lo imposta come marcato e
