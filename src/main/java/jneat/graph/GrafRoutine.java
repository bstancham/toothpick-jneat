   ...
   */
	  ...
	  // per fare questo , viene calcolato l'id del lato reale, inactive, che e stato
	  ...
	  // il nodo passato puo essere reale o virtuale ;
	  // nel caso sia reale il group_id = 0 , e di conseguenza la distanza vale 0;
	  // (vengono cosi privilegiati i nodi reali a distanza 1 e poi i nodi virtuali!).
	  // Se invece il punto _p , e virtuale, tale routine  , viene chiamata solo
	  ...
	  // ritornato proprio tale valore che e la distanza tra il nodo iniziale e quello 
