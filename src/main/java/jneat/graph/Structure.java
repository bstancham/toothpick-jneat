...
public class Structure {
    ...
    // tale vettore una volta costruito servira per comporre
    ...
    public void generate_virtual_Vertex_Edge_vertical()
    {
        ...
        while (itr_edge.hasNext())
			...
			// curr_edge_id = nome del lato che si sta analizzando
                        curr_edge_id = _edge.name;
                                ...
                                for (int livello = (to_node.level + 1); livello < from_node.level; livello++)
                                    {
                                        ...
                                        // dato che il nodo e connesso in una catena singola ed unica
                                        // il group id dei vertici e il nome del lato che li connette
            ...
            if (_plane.vEdge.size() > 0)
                {
                    ...
                    //	     System.out.print("\n Il piano di livello "+_plane.level +" ha "+_plane.dim_y+" righe  e avra "+xdim+" colonne");
    ...
    public void compute_depth_x()
    {
      ...
      * alla fine , quindi , e determinato depth_y = al numero REALE di livelli
    ...
    public void compute_depth_y()
    {
        ...
        /*
             ...
             System.out.print("\n Dopo primo calcolo da out verso input la situazione e : "+max_b);
             System.out.print("\n ******************************************************");
             view();
        ...
        */
        ...
        /*
             ...
             System.out.print("\n Dopo primo calcolo da inp  verso output  la situazione e : "+max_b);
             System.out.print("\n ******************************************************");
             //	  view();
        ...
        */
        ...
        // se il predecessore  non e  settato cioe se  non ha valori impostati cioe level = -1 e altitude = -1
        ...
        while (changed)
			...
			// cerca il nodo piu in basso verso cui il nodo e collegato
			// per fare questo esamino i nodi in uscita e vedo quale tra questi ha il
			// altitude piu bassa o livello piu alto;
						...
						if (_Vertey.altitude < xmin)
                                ...
                                // se found = true allora il nodo _Vz e il piu vicino
	  ...
	  System.out.print("\n **********************************************************************");
        */
        ...
        // per il momento non vengono visualizzati nodi che sono al di sotto dei sensori anche perche
        ...
        // (potrebbero cioe esistere delle sub-network internamente alla rete funzionante;
    ...
    public void create_Horiz_mXY()
    {
      ...
      * allora tale connessione e intrastrato
    ...
    public void create_plane()
    {
        ...
        for (int l = 0; l < depth_y; l++)
			...
			//
                ...
                // intra-strato , memorizzando anche i nodi per i quali dovra essere ricalcolato il livello
                // in quanto dovranmno fare posto alle connessioni  intra-strato
                // per fare cio legge i nodi del livello trovato e li memorizza su un vettore;
    ...
    public int  generate_Grafo()
    {
        ...
        // verticali distanti piu di un livello
            ...
            for (int row = 0; row < h_mXY.dim_y; row++)
                {
                    ...
                    // se si allora la distanza dalla precedente row e minore
