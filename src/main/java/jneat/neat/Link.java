...
/**
 * Link is a connection from one node to another with an associated weight; It can be
 * marked as recurrent; Its parameters are made public for efficiency.
 */
public class Link extends Neat {
    ...
    /**
     * this is a flag for compute depth; if TRUE the connection(link) is already analyzed;
     * FALSE otherwise;
     */
