...
public class NNode extends Neat {
    ...
    /**
     * <p>An NNode is encoded as a list of 4 numbers, for example:</p>
     *
     * <p>{@code node 2 0 1 1}</p>
     *
     * <p>The meaning of the numbers, in this order:</p>
     * <ul>
     * <li>Node ID</li>
     * <li>Node trait ID, or 0 if none</li>
     * <li>Node type, e.g. NeatConstant.SIGMOID</li>
     * <li>Node label. Used for genetic marking type of nodes.
     * Types are 0-4 in this order: HIDDEN/INPUT/OUTPUT/BIAS</li>
     * </ul>
     */
