...
public class Gene extends Neat {
    ...
    /**
     * <p>A Gene is encoded as a list of 8 numbers, for example:</p>
     *
     * <p>{@code gene 1 1 4 0.0 0 1 0 1}</p>
     *
     * <p>The meaning of the numbers, in this order:</p>
     * <ul>
     * <li>link trait ID, or 0 if none</li>
     * <li>link in-node ID</li>
     * <li>link out-node ID</li>
     * <li>link weight (double)</li>
     * <li>link is-recurrent (1/0)</li>
     * <li>innovation number</li>
     * <li>mutation number</li>
     * <li>enabled (1/0)</li>
     * </ul>
     */
