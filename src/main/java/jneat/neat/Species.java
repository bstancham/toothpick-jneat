...
public class Species extends Neat {
    ...
    /**
     * Costructor with only ID of species.
     */
    ...
    /**
     * <p>Can change the fitness of the organisms in the Species to be higher for very new
     * species (to protect them);</p>
     *
     * <p>Divides the fitness by the size of the Species, so that fitness is "shared" by
     * the species At end mark the organisms can be eliminated from this species.</p>
     */
    ...
    /**
     * Read all organisms in this species and compute the summary of fitness; at and
     * compute the average fitness (ave_fitness) with : ave_fitness = summary / (number of
     * organisms) this is an average fitness for this specie
     */
    ...
    /**
     * Read all organisms in this specie and return the maximum fitness of all organisms.
     */
    ...
    /**
     * <p>Compute the collective offspring the entire species (the sum of all organism's
     * offspring) is assigned.</p>
     *
     * <p>skim is fractional offspring left over from a previous species that was counted.
     * These fractional parts are kept unil they add up to one.</p>
     */
    ...
    /**
     * Costructor with identification and flag for signaling if its a new species.
     */
    ...
    /**
     * Eliminate the organism passed in parameter list, from a list of organisms of this
     * specie
     */
    ...
    /**
     * <p>Creates a single new organism by mating two of the sorted_species, then adds it
     * to the Population.</p>
     */
